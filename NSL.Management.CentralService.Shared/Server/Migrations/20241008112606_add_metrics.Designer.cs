...
namespace NSL.Management.CentralService.Shared.Server.Migrations
{
    ...
    [Migration("20241008112606_add_metrics")]
    partial class add_metrics
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NSL.Management.CentralService.Shared.Models.ServerLogModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("NSL.Management.CentralService.Shared.Models.ServerMetricsModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("NSL.Management.CentralService.Shared.Models.UserModel", null)
                        .WithMany()
            ...
            modelBuilder.Entity("NSL.Management.CentralService.Shared.Models.ServerLogModel", b =>
                {
                    b.HasOne("NSL.Management.CentralService.Shared.Models.ServerModel", "Server")
                        .WithMany("Logs")
